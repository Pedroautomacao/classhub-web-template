  ...
  return (
    <Box
      ...
      sx={{
        position: 'relative',
        overflow: 'hidden',
        // Layout em coluna pra distribuir título no topo e descrição+botão
        // na base, deixando o "rosto" da imagem visível no meio.
        display: 'flex',
    ...
    >
      ...
      >
        ...
        {/* Spacer flexível — empurra o bloco abaixo pra base */}
        <Box sx={{ flexGrow: 1, minHeight: { xs: 24, md: 40 } }} />

        {/* Bloco inferior: descrição + CTA */}
        {loading ? (
          <Skeleton
            variant="text"
            width="80%"
